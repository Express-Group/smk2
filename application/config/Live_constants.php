...
//define('source_base_path', '/home/nie_images/');
//define('destination_base_path', '/home/nie_images/');

define('source_base_path', '/var/www/html/indulge_demo/');
define('destination_base_path', '/var/www/html/indulge_demo/');
...
//define('image_url', 'http://images.newindianexpress.com/');
define('no_articles', 'Please add articles to show');	
//define('BASEURL', 'http://www.newindianexpress.com/');
//define('HOMEURL', 'http://cms.newindianexpress.com/');

define('image_url', 'http://www.indulgexpress.com/');
define('BASEURL', 'http://www.indulgexpress.com/');
define('HOMEURL', 'http://www.indulgexpress.com/');
